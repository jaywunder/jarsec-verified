...
correct (seq cfg₁ cfg₂) cs | r₁ ∷ rs₁ | a₁ ∷ all₁ | [] | all₂ = {!   !}
correct (seq cfg₁ cfg₂) cs | r₁ ∷ rs₁ | a₁ ∷ all₁ | r₂ ∷ rs₂ | all₂ = {!   !}
  where
    -- all>>= :
    --   let L = List Char
    ...
    strengthen-to-seq | r₁ ∷ rs₁ | a₁ ∷ all₁ | [] | all₂ = {! a₁  !}
    strengthen-to-seq | r₁ ∷ rs₁ | a₁ ∷ all₁ | r₂ ∷ rs₂ | all₂ = {!   !}
